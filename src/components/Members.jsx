...
//         <p className='text-center text-[#9C7509] text-4xl font-merry font-extrabold'>Team Of Experts</p>
//     </div>
...
//   </div>
// </div> */}
// <div ref={divlef} className="card bg-[#493E1D] mb-6 w-64 h-80 md:h-[420px] md:w-90 shadow-xl">
//   <figure>
//     <img
//       src="https://agcoin.io/wp-content/uploads/2021/04/martin-photo2.jpg"
//       alt="Shoes"
...
// <div className="card bg-[#493E1D] w-64 h-80 md:h-[420px] md:w-90 shadow-xl">
//   <figure>
//     <img
...
// <div ref={divrig} className="card bg-[#493E1D] w-64 h-80 md:h-[420px] md:w-90 shadow-xl">
//   <figure>
//     <img
...
const Members = () => {
  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="font-san">
          {/* <CanvasScene /> */}
          <p className="text-center text-gray-300 font-bold font-merry">
            OUR AMAZING
          </p>
          <p className="text-center text-[#9C7509] text-4xl font-merry font-extrabold">
            Team Of Experts
          </p>
        </div>
        <div className="flex flex-wrap font-san justify-center gap-6 md:gap-16 mt-8 ">
  ...
  <div className="card-body items-center text-center">
    ...
    <p className='text-white'><b>Founder, CEO</b></p>
          ...
          <div
            ref={divlef}
            className="card bg-[#493E1D] mb-6 w-64 h-80 md:h-[420px] md:w-90 shadow-xl"
          >
            <figure>
              <img
                src="https://agcoin.io/wp-content/uploads/2021/04/martin-photo2.jpg"
          ...
          <div
            ref={divrig}
            className="card bg-[#493E1D] w-64 h-80 md:h-[420px] md:w-90 shadow-xl"
          >
            <figure>
              <img
                src="https://agcoin.io/wp-content/uploads/2021/03/omar-e1616787014904.jpg"
