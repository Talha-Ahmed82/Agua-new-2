                        ...
                        <div className="education-box">
                            ...
                            <div className="education-content">
                                ...
                                <div className="content">
                                    ...
                                    <h3 className='text-2xl text-[#FFBE47]'  >Phase: Foundation and Whitepaper Finalization (Q3 2024)</h3>
        ...
        /> <span className='text-xl'>  Initial Community </span> 
                            ...
                            <div className="education-content">
                                ...
                                <div className='content mt-3'>
                                    ...
                                    <h3  className='text-2xl  text-[#FFBE47]' > Phase 2: Token Launch and Initial Platform Development (Q4 2024)</h3>
        ...
        /> <span className='text-xl'>  Staking Platform Launch </span> 
                            ...
                            <div className="education-content">
                                ...
                                <div className="content">
                                    ...
                                    <h3  className='text-2xl  text-[#FFBE47]'  >Phase 3: Mining Integration and Reserve Management (Q1-Q2 2025)</h3>
                        ...
                        <div className="education-box">
                            ...
                            <div className="education-content">
                                ...
                                <div className="content">
                                    ...
                                    <h3  className='text-2xl  text-[#FFBE47]' >Phase 4: Platform Expansion and DeFi Integration (Q3-Q4 2025)</h3>
        ...
        /> <span className='text-xl'>   Community Incentive Programs </span> 
                            ...
                            <div className="education-content">
                                ...
                                <div className="content">
                                    ...
                                    <h3  className='text-2xl  text-[#FFBE47]' >Phase 5: Global Expansion and Regulatory Alignment (2026)</h3>
        ...
        /> <span className='text-xl'>    Global Marketing Campaign</span> 
                            ...
                            <div className="education-content">
                                ...
                                <div className="content">
                                    ...
                                    <h3  className='text-2xl  text-[#FFBE47]' >Phase 6: Continuous Improvement and Ecosystem Growth (2027 and Beyond)</h3>
