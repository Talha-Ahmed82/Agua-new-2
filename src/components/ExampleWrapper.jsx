...
//         Roadmap
//       </h1>
//       <ul className="timeline space-y-10 timeline-vertical">
//         <li>
//           <div className="timeline-start w-60 timeline-box bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509]">
//             <button
...
//             </svg>
//           </div>
//           <div className="timeline-end w-60  timeline-box bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509]">
//             <button
...
//                     </div> */}
//                 <h3 className="text-3xl font-bold text-center mb-2">
//                   Phase 6: Continuous Improvement and Ecosystem Growth (2027 and
//                   Beyond)
//                 </h3>
//                 <p className="mb-4 text-black">
//                   {" "}
...
const ExampleWrapper = () => {
  ...
  return (
    <>
      ...
      <ul className="timeline space-y-10 timeline-vertical">
        <li>
          <div className="timeline-start md:w-60 w-30 timeline-box bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509]">
            <button
              onMouseEnter={() => setIsOpen(true)}
              className="text-black font-medium px-4 py-2 rounded hover:opacity-90 transition-opacity"
            >
        ...
        <li>
          ...
          <div className="timeline-end md:w-60 w-30 timeline-box bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509]">
            <button
              onMouseEnter={() => setIsOpen2(true)}
              className="text-black font-medium px-4 py-2 rounded hover:opacity-90 transition-opacity"
            >
