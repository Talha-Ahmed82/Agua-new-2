...
function Chart() {
 ...
 <hr className="border-[#D2BA57]" /> */}
      <div className="relative">
        ...
        />
        <h1 className="font-merry text-5xl md:text-6xl text-yellow-400 text-center mt-6 ">
          Tokenomics
        </h1>
        <div className="flex flex-col lg:flex-row w-full h-auto space-y-10 lg:space-y-0 font-san lg:space-x-20 justify-center items-center">
          {/* <CanvasScene /> */}
                ...
                <div key={index}>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      {/* Bullet Point */}
                      {/* <span className="w-2.5 h-2.5 bg-white rounded-full"></span> */}
                      <p className="text-sm sm:text-base font-roboto lg:text-xl font-bold bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] bg-clip-text text-transparent">
                        {item.title}
                      </p>
                    </div>
              ...
              {[
                ...
                <div className="mb-16" key={index}>
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      {/* <span className="w-2.5 h-2.5 bg-white rounded-full"></span> */}
                      <p className="text-sm sm:text-base lg:text-xl font-roboto font-bold bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] bg-clip-text text-transparent">
                        {item.title}
                      </p>
                    </div>
                    <p className="text-sm sm:text-base font-roboto lg:text-lg font-bold bg-gradient-to-r from-[#F6F700] via-yellow-400 to-[#9C7509] bg-clip-text text-transparent">
